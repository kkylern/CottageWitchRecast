...
StartupEvents.registry('item', event => {
    ...
    event.create('witch_type_item').maxStackSize(1).glow(true).displayName("Tome of Witchery")
...
// Carved Dark Oak Logs
  event.create('carved_dark_oak_1')
  ...
  event.create('carved_dark_oak_2')
  ...
  event.create('carved_dark_oak_3')
  ...
  event.create('carved_dark_oak_4')
  ...
  event.create('carved_dark_oak_5')
  ...
  //TODO - rotation
  event.create('carved_dark_oak_6')
  ...
  event.create('carved_dark_oak_7')
  ...
  event.create('carved_dark_oak_8')
