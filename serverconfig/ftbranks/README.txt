...
Last README file update: Tue Jun 04 20:14:11 CDT 2024
...
command.nutritionalbalance
command.nutritionalbalance.get_nutrients
command.nutritionalbalance.get_unassigned_foods
command.nutritionalbalance.reset_player_effect
command.nutritionalbalance.set_nutrient
command.nutritionalbalance.set_nutrient.nutrient
command.nutritionalbalance.set_nutrient.nutrient.value
command.nutritionalbalance.sync
command.observable
...
command.shoppy
command.shoppy.admin_shop
command.shoppy.admin_shop.block
command.shoppy.npc_shop
command.shoppy.npc_shop.block
command.spawn
command.spawnpoint
...
command.ue
command.ue.remove_deaths_odium
command.ue.remove_deaths_odium.player
command.unmute
